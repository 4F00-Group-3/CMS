    ...
    return (
      <div className="popup">
        <div className="popup_inner">
          ...
          <button
            className="submitnextbutton"
            onClick={this.handleDeleteWebsite}
          >
            Delete
          </button>
          <br />
          <br />
          <button className="submitnextbutton" onClick={this.props.closePopup}>
            Cancel
          </button>
        </div>
      </div>
...
class SitePage extends Component {
  constructor(props) {
    ...
    this.handleRedirectToAccoutingSettings = this.handleRedirectToAccoutingSettings.bind(
      this
    );
    ...
    if (
      ...
      sessionStorage.getItem("tier") === null
    ) {
  ...
  componentDidMount() {
    ...
    if (sessionStorage.getItem("id") !== null) {
      ...
      AjaxCall(
        { function: "getWebsiteData", accountId: sessionStorage.getItem("id") },
        function (response) {
      ...
      <>
        {userLoggedIn ? (
          <div className="SitePage">
            <div className="Menu">
              <p onClick={this.handleRedirectToAccoutingSettings}>
                Account Settings
              </p>
                        ...
                        <div className="SiteIcon">
                          ...
                          <div className="row">
                            <div className="column">
                              <button
                                onClick={() => this.handleEditWebsite(site.id)}
                                value="Edit"
                              >
                                Edit
                              </button>
                            ...
                            <div className="column">
                              <button
                                onClick={() =>
                                  this.handleViewWebsite(site.path)
                                }
                                value="View"
                              >
                                View
                            ...
                            <div className="column">
                              <button
                                onClick={() => this.handleDeleteWebsite(this)}
                                value="Delete"
                              >
                                Delete
                              </button>
                              {this.state.showPopupDelete ? (
                                <PopupDelete
                                  ...
                                  closePopup={this.handleDeleteWebsite.bind(
                                    this
                                  )}
                                />
                              ) : null}
